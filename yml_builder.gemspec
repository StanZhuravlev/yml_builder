...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Набор классов для формирования и валидации прайс-листов в формате Яндекс YAML.
                          В текущей версии поддерживает только упрощенные товарные карточки.}
